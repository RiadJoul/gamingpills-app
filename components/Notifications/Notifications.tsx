            ...
            <>
              <Popover.Button
                className={` ${
                  ...
                  "animate-bounce bg-primary"
                }
                group ml-2 lg:ml-0 inline-flex space-x-3 items-center rounded-md bg-dark px-3 py-2 text-base font-medium text-white hover:text-opacity-100`}
              >
                <span className="flex text-xl lg:text-2xl">
                  <CgPill />{" "}
              ...
              >
                <Popover.Panel className="absolute left-1/4 lg:left-1/2 z-10 ml-10 lg:ml-40 mt-3 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-xl">
                  <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="relative grid gap-8 bg-white p-7 lg:grid-cols-1">
                      {notifications.length > 0 ? (
                        <>
                          ...
                          >
                            <div className="ml-4 capitalize">
                              <p className="text-center text-black lg:text-base text-sm font-semibold cursor-pointer">
                                Mark as read
                              </p>
                            </div>
                          </a>
                        ...
                        <a className="-m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out focus:outline-none focus-visible:ring focus-visible:ring-primary focus-visible:ring-opacity-50">

...
const Chart = () => {
    return (
        <div className="flex flex-col items-center w-full  p-6 pb-6 mt-10 bg-dark text-white rounded-lg shadow-xl sm:p-8">
        ...
        <div className="flex w-full mt-3">
            <div className="flex items-center ml-auto">
                ...
                <span className="ml-1 text-xs font-medium">Bets</span>
            </div>
            <div className="flex items-center ml-4">
                <span className="block w-4  h-4 bg-indigo-300"></span>
                <span className="ml-1 text-xs font-medium">Challenges</span>
            </div>
            <div className="flex items-center ml-4">
                <span className="block w-4  h-4 bg-indigo-200"></span>
                <span className="ml-1 text-xs font-medium">Profit</span>
            </div>
        </div>
    </div>
    )
